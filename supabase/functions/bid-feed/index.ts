...
const FEEDS = [
  ...
  // Blue Book — Litchfield County CT contractors
  {
    name: "Blue Book Litchfield CT",
    url: "https://www.thebluebook.com/products/bluesearchtechnology/search-companies.html?searchTerm=General+Contractors&location=Litchfield+County%2C+CT&radius=50",
    type: "html",
    state: "CT",
  },
  // Blue Book — Berkshire County MA contractors
  {
    name: "Blue Book Berkshire MA",
    url: "https://www.thebluebook.com/products/bluesearchtechnology/search-companies.html?searchTerm=General+Contractors&location=Berkshire+County%2C+MA&radius=50",
    type: "html",
    state: "MA",
  },
  // Blue Book — Excavating contractors CT
  {
    name: "Blue Book Excavating CT",
    url: "https://www.thebluebook.com/products/bluesearchtechnology/search-companies.html?searchTerm=Excavating+Contractors&location=Litchfield+County%2C+CT&radius=50",
    type: "html",
    state: "CT",
  },
  // Blue Book — Paving contractors CT/MA
  {
    name: "Blue Book Paving CT",
    url: "https://www.thebluebook.com/products/bluesearchtechnology/search-companies.html?searchTerm=Paving+Contractors&location=Torrington%2C+CT&radius=40",
    type: "html",
    state: "CT",
  },
  // Blue Book — Springfield MA contractors
  {
    name: "Blue Book Springfield MA",
    url: "https://www.thebluebook.com/products/bluesearchtechnology/search-companies.html?searchTerm=General+Contractors&location=Springfield%2C+MA&radius=40",
    type: "html",
    state: "MA",
  },
];
...
Extract construction project bids, awards, AND contractor/company listings from this content from "${feedName}".

ONLY extract items in these target areas: ${TARGET_AREAS.join(", ")}.

If this is a Blue Book company listing page, extract each company as a project lead with:
- project set to the company name + " — Equipment Rental Prospect"
- owner set to the company name
- gc set to the company name
- type based on their trade (GC = Commercial, Excavating = Municipal, Paving = Municipal)
- notes including their trade specialty and any contact info visible

For each item found, return a JSON array. Each item must have:
